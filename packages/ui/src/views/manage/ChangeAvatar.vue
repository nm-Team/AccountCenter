    ...
    <div class="block" v-if="!avatarEnabled && changeStep == 0">
        ...
        <div class="typeSelecterA">
            ...
            <button class="type" @click="avatarType = 'qq'; changeStep = 1; ">
                <svg style="transform: scale(1.2)" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <button class="type" @click="avatarType = 'github'; changeStep = 1; ">
                <svg style="transform: scale(1.1)" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <path
...
export default {
  ...
  User(token: $token) {
    changeAvatar(avatar: $avatar)
                ...
                this.newUser.avatar = this.newAvatarCode;
